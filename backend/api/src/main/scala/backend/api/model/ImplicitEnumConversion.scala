...
import backend.api.model.enums.CameraDto.*
import backend.api.model.enums.LensDto.*
import backend.api.model.enums.*
import backend.api.model.enums.CameraTechniqueDto.*
import backend.api.model.enums.CategoryDto.*
import backend.photo.entities.gear.{Camera, Lens}
import backend.photo.entities.gear.Camera.Camera
import backend.photo.entities.gear.Lens.Lens
import backend.photo.entities.meta.{CameraTechnique, Category}
