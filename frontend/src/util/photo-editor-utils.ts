...
export const stateIsComplete = (state: PhotoEditorState): boolean =>
  state.camera !== undefined &&
  state.lens !== undefined &&
  state.focalLength !== undefined &&
  state.focalLength !== '' &&
  state.aperture !== undefined &&
  state.aperture !== '' &&
  state.exposureTime !== undefined &&
  state.exposureTime !== '' &&
  state.iso !== undefined &&
  state.iso !== '' &&
...
export const convertStateToPhotoContent = (
