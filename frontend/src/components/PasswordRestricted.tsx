...
import {
  ...
  DialogTitle, FormControl, IconButton, InputAdornment, InputLabel, OutlinedInput, TextField,
} from '@mui/material';
...
export const PasswordRestricted: FC<PropsWithChildren<Props>> = ({
  children, hideChildrenIfBlocked,
}) => {
  const [showPassword, setShowPassword] = useState<boolean>(false);
  const [hasValidatedPassword, setHasValidatedPassword] = useState<boolean>(false);
  ...
  const { trigger: triggerValidation, data: isValid, loading } = usePromise(validatePassword);
      ...
      <Dialog open={isValid === undefined || !isValid} onClose={undefined}>
        ...
        <DialogContent>
          {!loading && (
            <>
              <DialogContentText>
                This part of the website is intended for admins and is password protected.
              ...
              <form id="password_form" onSubmit={triggerValidation}>
                ...
                <FormControl fullWidth sx={{ m: 1 }} variant="outlined">
                  ...
                  <OutlinedInput
                    ...
                    error={hasValidatedPassword && !isValid && passwordInput === invalidPassword}
        ...
        <DialogActions>
          ...
          <Button
            type="submit"
            form="password_form"
            disabled={loading || passwordInput === '' || passwordInput === invalidPassword}
